...
namespace DBDhelp {
	...
	public:
		...
		mainForm(void)
		{
			...
			RegisterHotKey(hwnd, 1, MOD_NOREPEAT, 0x70); //F1
			RegisterHotKey(hwnd, 2, MOD_NOREPEAT, 0x71); //F2
			RegisterHotKey(hwnd, 3, MOD_NOREPEAT, 0x72); //F3
			RegisterHotKey(hwnd, 4, MOD_NOREPEAT, 0x73); //F4
			RegisterHotKey(hwnd, 5, MOD_NOREPEAT, 0x74); //F5
			RegisterHotKey(hwnd, 6, MOD_NOREPEAT, 0x75); //F6
			RegisterHotKey(hwnd, 7, MOD_NOREPEAT, 0x76); //F7
			RegisterHotKey(hwnd, 8, MOD_NOREPEAT, 0x77); //F8
		}
...
#pragma endregion
	...
	public: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->pictureBox3->Hide();
		this->pictureBox5->Hide();
		if (firstHooks < 2) { firstHooks++; TotalHooks++; }
		if (firstHooks == 1) { this->pictureBox2->Show(); }
		if (firstHooks == 2) { this->pictureBox3->Show(); this->pictureBox2->Show(); }
		if (firstHooks == 3) { this->pictureBox5->Show(); this->pictureBox3->Show(); this->pictureBox2->Show(); }
		this->label2->Text = TotalHooks.ToString();
		  ...
		  //aaaaaaaaaaaaaaaaaassssssssssssssaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
	...
	public: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->pictureBox9->Hide();
		this->pictureBox7->Hide();
		if (secondHooks < 2) { secondHooks++; TotalHooks++; }
		if (secondHooks == 1) { this->pictureBox10->Show(); }
		if (secondHooks == 2) { this->pictureBox9->Show(); this->pictureBox10->Show(); }
		if (secondHooks == 3) { this->pictureBox7->Show(); this->pictureBox9->Show(); this->pictureBox10->Show(); }
		this->label2->Text = TotalHooks.ToString();
	...
	public: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->pictureBox12->Hide();
		this->pictureBox11->Hide();
		if (thirdHooks < 2) { thirdHooks++; TotalHooks++; }
		if (thirdHooks == 1) { this->pictureBox13->Show(); }
		if (thirdHooks == 2) { this->pictureBox12->Show(); this->pictureBox13->Show(); }
		if (thirdHooks == 3) { this->pictureBox11->Show(); this->pictureBox12->Show(); this->pictureBox13->Show(); }
		this->label2->Text = TotalHooks.ToString();
	}
		  System::Void button7_Click()
		  {
			  this->pictureBox13->Hide();
			  this->pictureBox12->Hide();
			  this->pictureBox11->Hide();
	...
	public: System::Void button8_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->pictureBox15->Hide();
		this->pictureBox14->Hide();
		if (fourthHooks < 2) { fourthHooks++; TotalHooks++; }
		if (fourthHooks == 1) { this->pictureBox16->Show(); }
		if (fourthHooks == 2) { this->pictureBox15->Show(); this->pictureBox16->Show(); }
		if (fourthHooks == 3) { this->pictureBox14->Show(); this->pictureBox15->Show(); this->pictureBox16->Show(); }
		this->label2->Text = TotalHooks.ToString();
	}
		  System::Void button8_Click()
		  {
			  this->pictureBox16->Hide();
			  this->pictureBox15->Hide();
			  this->pictureBox14->Hide();
